<?php
/*
Plugin Name: ContentLink Recommended Articles Box Plugin
Description: Displays a box with links to 5 additional articles on the home page and article page.
Version: 2.0
Author: Sisyphus
*/
...
// Function to display related articles on the article page
function rab_display_related_articles($content) {
    ...
    if (is_single() && in_the_loop() && is_main_query()) {
        ...
        if (isset($_COOKIE['content-link'])) {
            ...
            $visitor_id = base64_decode(sanitize_text_field($_COOKIE['content-link'])); // Decode and sanitize the visitor ID
...
// Function to display related articles on the home page
function rab_display_related_articles_on_home() {
    ...
    if (is_home() && is_main_query()) {
        ...
        if (!empty($related_urls)) {
            ...
            echo '<div class="related-articles-box">';
            echo '<h3>Recommended Articles</h3>';
            echo '<ul>';
...
add_action('wp', 'rab_display_related_articles_on_home');
